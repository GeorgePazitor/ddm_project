...
n_min_dofs = 1000;
n_max_dofs = 23000;    % n = number of elements -> n+1 nodes
...
%% FEM -------------------------------------------------------------------
    ...
    H = i*0.05;    % (10) H = lenght of a substructure (must be a divisor of L)
    ...
    time_taken_primal(j) = t_init_local + t_sp + t_final_local ;
